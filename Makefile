...
#added _lab3_test & _lab3_testS\ \\ CS 153
UPROGS=\
	_cat\
	_echo\
	_forktest\
...
#added lab3_test.c & lab3_testS.c // CS 153
EXTRA=\
	mkfs.c ulib.c user.h cat.c echo.c forktest.c grep.c kill.c lab3_test.c lab3_testS.c\
